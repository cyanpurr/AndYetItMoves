...
$instantResource = new ScriptObject(Name : "")
{
	...
	Name = "jungle1Art";
	User = "TGB";
	LoadFunction = "jungle1Art::LoadResource";
	UnloadFunction = "jungle1Art::UnloadResource";
}
function jungle1Art::LoadResource(%this)
{
...
function jungle1Art::UnloadResource(%this)
{
...
$instantResource.Data = new SimGroup(Name : "")
{
	...
	{
		imageName = "./images/banana_squashed.png";
		imageMode = "CELL";
		frameCount = "-1";
		filterMode = "SMOOTH";
		filterPad = "1";
	...
	new t2dImageMapDatablock(Name : bananaLinkImage)
	{
		imageName = "~/managed/";
		imageMode = "LINK";
		frameCount = "-1";
		...
		cellWidth = "0";
		cellHeight = "0";
		linkImageMaps = "bananaImageMap banana_squashedImageMap";
		preload = "1";
		allowUnload = "0";
	}
	new t2dImageMapDatablock(Name : monkeyBodyImageMap)
	{
		imageName = "./images/monkeyBody.png";
		imageMode = "FULL";
		frameCount = "-1";
		filterMode = "SMOOTH";
		filterPad = "0";
	...
	{
		imageName = "./images/monkeyHead.png";
		imageMode = "FULL";
		frameCount = "-1";
		filterMode = "SMOOTH";
		filterPad = "0";
...
if ($soundEnabled)
{
	Data.add(new AudioProfile(Name : MonkeyLoop), new AudioProfile(Name : MonkeyEating), new AudioProfile(Name : BananenSpawn), new AudioProfile(Name : BananenSquish));
}
